...
window.cardExplanations = {
    ...
    "Работа с документами (Расшифровка записей диктофона)": "ам нужно записать аудио в приложении Диктофон и продемонстрировать функцию расшифровки",
    ...
    "Студия AI (Улучшение групповых портретов)": "ПВам необходимо продемонстрировать, где находится функция включения Улучшения групповых портретов",
